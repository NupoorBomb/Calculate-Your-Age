...
if __name__ == "__main__" : 
	...
	# Create a Day : label 
	day = Label(gui, text = "Date", bg = "light blue") 
	...
	givenDay = Label(gui, text = "Given Date", bg = "light blue") 
	...
	resultantAge = Button(gui, text = "Calculated Age", fg = "Black", bg = "light Green", command = calculateAge) 

	# Create a Clear All Button and attached to clearAll function 
	clearAllEntry = Button(gui, text = "Reset", fg = "Black", bg = "yellow", command = clearAll) 
